...
/**
 * author: baiiu
 * date: on 16/7/8 17:45
 * description: 复制DefaultItemAnimator
 */
public class LearnDefaultItemAnimator extends SimpleItemAnimator {
    ...
    private static class ChangeInfo {
        ...
        private ChangeInfo(RecyclerView.ViewHolder oldHolder, RecyclerView.ViewHolder newHolder, int fromX,
    ...
    /*
        ...
        This state is governed by the return values from some related methods.

        很明显,执行的是在其他方法中添加进来的Holder要执行的方法,该方法是动画执行的主要方法
     */
    ...
    private void animateMoveImpl(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX,
            int toY) {
        final View view = holder.itemView;
    ...
    void cancelAll(List<RecyclerView.ViewHolder> viewHolders) {
        for (int i = viewHolders.size() - 1; i >= 0; i--) {
            ViewCompat.animate(viewHolders.get(i).itemView)
                    .cancel();
        }
    }
     ...
     * <ul>
     * <li>If you override {@link #animateChange(RecyclerView.ViewHolder, RecyclerView.ViewHolder, int, int,
     * int, int)}, both
     * ViewHolder arguments will be the same instance.
     * </li>
     * <li>
     * If you are not overriding {@link #animateChange(RecyclerView.ViewHolder, RecyclerView.ViewHolder,
     * int, int, int, int)},
     * then DefaultItemAnimator will call {@link #animateMove(RecyclerView.ViewHolder, int, int, int, int)}
     * and
