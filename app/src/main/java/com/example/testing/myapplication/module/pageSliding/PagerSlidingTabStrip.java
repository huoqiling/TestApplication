...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int indicator_bottom_margin = UIUtil.dp(getContext(), 4);
    private int indicator_width = UIUtil.dp(getContext(), 8);
    ...
    private void scrollToChild(int position, float positionOffset) {
        ...
        int offset = (int) (child.getMeasuredWidth() * positionOffset + 0.5);
        ...
        if (position + 1 < tabCount) {
            //下一个node的右边
            right = tabsContainer.getChildAt(position + 1)
                    .getRight();
        }
        ...
        LogUtil.d(position + ", " + offset + ", " + left + ", " + right + ", " + getScrollX());
        ...
        //    scrollTo(right - getMeasuredWidth() + offset, 0);
        //}
